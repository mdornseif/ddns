...
extern unsigned int scan_charsetnskip(const char *,char *,unsigned int);
extern unsigned int scan_noncharsetnskip(const char *,char *,unsigned int);

extern unsigned int scan_strncmp(const char *,char *,unsigned int);
extern unsigned int scan_memcmp(const char *,char *,unsigned int);
