...
extern char *dns_domain_suffix(const char *big,const char *little);
...
extern int dns_transmit_start(struct dns_transmit *,char *,int,const char *,const char *,const char *);
...
extern int dns_ip6_4mapped(stralloc *,stralloc *);	/* dns_ip4 converted to
							   IPv4-mapped */
extern int dns_name_packet(stralloc *,const char *,unsigned int);

extern void dns_name4_domain(char *,const char *ip);
#define DNS_NAME4_DOMAIN 31
extern int dns_name6_domain(char *,const char *ip);
#define DNS_NAME6_DOMAIN (4*16+15)

extern int dns_name4(stralloc *,const char *ip);
extern int dns_name6(stralloc *,const char *ip);
...
extern int dns_ip6_qualify_4mapped(stralloc *,stralloc *,stralloc *);
