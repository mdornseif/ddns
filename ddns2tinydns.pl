#!/usr/bin/perl
#
# $Id: ddns2tinydns.pl,v 1.1 2000/04/26 00:36:40 drt Exp $
#
...
print <<EOD;
# autogenerated
.dyn.walledcity.rc23.cx:62.159.58.131:gate-walledcity-rc23-cx
.walledcity.rc23.cx:62.159.58.131:gate-walledcity-rc23-cx
